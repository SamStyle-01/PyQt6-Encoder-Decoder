...
class SamInstruction(QMainWindow):
    def __init__(self):
        ...
        self.text_in.setPlainText("1. Опция \"Создать и зашифровать файл\". Здесь вы можете ввести текст, после чего "
                                  ...
                                  "в нём.\n\n3. Опция \"Зашифровать существующий файл\". Похожа на 1 опцию, "
                                  "но отличие в том, что текст вы не вводите, "
                                  "а автоматически берёте из файла. И туда же "
                                  "(в этот же файл) записываете его в зашифрованном виде.\n\n4. Опция \"Расшифровать "
                                  "существующий файл\". Похожа на 2 опцию, но в этом случае вы не выводите всё на "
